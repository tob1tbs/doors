        ...
        <div class="nk-header-wrap">
            ...
            <div class="nk-header-menu" data-content="headerNav">
                ...
                <ul class="nk-menu nk-menu-main ui-s2">
                    ...
                    <li class="nk-menu-item has-sub">
                        <a href="#" class="nk-menu-link nk-menu-toggle">
                            <span class="nk-menu-text">შეკვეთები - მიწოდება</span>
                        </a>
                        <ul class="nk-menu-sub">
                            <li class="nk-menu-item">
                            ...
                            <li class="nk-menu-item">
                                <a href="{{ route('actionOrdersWarehouse') }}" class="nk-menu-link">
                                    <span class="nk-menu-text">საწყობები</span>
                                </a>
                            </li>
                            <li class="nk-menu-item">
                    ...
                    <li class="nk-menu-item has-sub">
                        <a href="#" class="nk-menu-link nk-menu-toggle">
                            <span class="nk-menu-text">ფინანსები</span>
                        </a>
                        <ul class="nk-menu-sub">
                            <li class="nk-menu-item">
                                <a href="{{ route('actionFinanceIndex') }}" class="nk-menu-link">
                                    <span class="nk-menu-text">რეპორტი</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li class="nk-menu-item has-sub">
                        ...
                        <ul class="nk-menu-sub">
                            <li class="nk-menu-item">
                                <a href="{{ route('actionWebParametersIndex') }}" class="nk-menu-link">
                                    <span class="nk-menu-text">ვებ გვერდის პარამეტრები</span>
                                </a>
                            </li>
                            <li class="nk-menu-item">
