                            ...
                            <div class="card-aside card-aside-left user-aside toggle-slide toggle-slide-left toggle-break-lg" data-content="userAside" data-toggle-screen="lg" data-toggle-overlay="true">
                                <div class="card-inner-group" data-simplebar>
                                    <div class="card-inner">
                                        <div class="user-card">
                                            <div class="user-info">
                                                <span class="lead-text font-neue">{{ $company_data->name }} / {{ $company_data->code }}</span>
                                    ...
                                    <div class="card-inner">
                                        <div class="user-account-info py-0">
                                            <h6 class="overline-title-alt">{{ $company_data->companyCustomer->name }} / {{ $company_data->companyCustomer->lastname }}</h6>
                                            <h6 class="overline-title-alt">{{ $company_data->companyCustomer->phone }} / {{ $company_data->companyCustomer->email}}</h6>
                                        </div>
                                    </div>
